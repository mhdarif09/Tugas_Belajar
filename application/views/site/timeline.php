      ...
      <?php foreach ($data as $key): ?>
        ...
        <li>
          ...
          <div class="timeline-item">
            ...
            <h3 class="timeline-header"><a href="#"><?php echo $key->notif_title; ?></a></h3>
      ...
      <?php foreach ($data_user as $data): ?>
        ...
        <li>
            ...
            <div class="timeline-item">
                ...
                <h3 class="timeline-header">Selamat Datang <?php echo $data->dinas_nama; ?></h3>
                ...
                <div class="timeline-footer">
                    <a href="<?php echo URL; ?>" class="btn btn-primary btn-xs">Pergi Ke Home</a>
                </div>
            </div>
        </li>
      <?php endforeach; ?>
